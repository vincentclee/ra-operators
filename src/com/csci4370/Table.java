       ...
       implements Serializable
{
    ...
    public Table minus (Table table2)
    {
         ...
         * 
         * MINUS is a SQL set operation that selects elements from the first table and 
         * then removes rows that are also returned by the second SELECT statement.
         * 
         * For example, the below query will return all rows that are in table_A, but 
         * not in table_B:
         * 
         *  SELECT * FROM table_A
         *  MINUS
         *  SELECT * FROM table_B;
         *  
         *  Additionally, if there are two identical rows in table_A, and that same 
         *  row exists in table_B, BOTH rows from table_A will be removed from the result set. 
         */
    ...
    public Table join (String attributes1, String attributes2, Table table2)
    {
        ...
        for (Map.Entry <KeyType, Comparable []> e : index.entrySet ()) {
        	...
        	System.arraycopy(table2Temp, 0, combined, e.getValue().length, table2Temp.length);
