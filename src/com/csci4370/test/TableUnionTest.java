...
public class TableUnionTest {
	...
	public void testUnion() {
		...
		/**
		 * assertEquals takes three parameters, the number of tuples, the actual
		 * size of the union table, and the predicted number of tuples for
		 * checking the correctness. If the number of tuples is as predicted the
